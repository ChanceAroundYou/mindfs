          ...
          >
            ...
            <div data-onboarding="input-controls" style={{ position: "absolute", right: isMobile ? "4px" : "8px", bottom: isMultiLine ? "6px" : "50%", transform: isMultiLine ? "none" : "translateY(50%)", display: "flex", alignItems: "center", gap: isMobile ? "0px" : "2px", zIndex: 5, transition: "all 0.2s cubic-bezier(0.4, 0, 0.2, 1)" }}>
              ...
              <>
                ...
                style={{
                  ...composerIconButtonStyle({
                    enabled: !!currentRootId && !sending,
                    tone: pendingAttachments.length > 0 ? "accent" : "default",
                  }),
              ...
              >
                ...
                style={{
                  ...composerSendButtonStyle({ enabled: canSend, cancel: showCancel, cancelling }),
                  background: showCancel ? "rgba(239,68,68,0.14)" : (canSend ? accentColorRaw : "transparent"),
                }}
              >
                {sending || cancelling ? (
                  <SpinnerIcon />
